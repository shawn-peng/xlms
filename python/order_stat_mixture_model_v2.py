...
class OrderStat2c:
    ...
    def _dist1_higher(self):
        ...
        factor_1 = scipy.integrate.quad_vec(unnormalized, -inf, self.dist1.mu)[0]
        factor_2 = scipy.integrate.quad_vec(unnormalized, self.dist1.mu, inf)[0]
...
class OrderStatMixtureModelV2:
    def __init__(self,
        ...
        # self.comps = {'C': Norm(), 'IC': Norm(), 'I': SN(-1)}
        self.comps = comps
        # self.join_comps = [
        #     ['C', 'C', 'IC', 'IC', 'I'],
        #     ['IC', 'I', 'IC', 'I', 'I'],
