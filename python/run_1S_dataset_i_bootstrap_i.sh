...
python run_bootstrap.py -c $conf -s 1 -d $dataset -q $part --suffix _${mu_strategy} --mu_strategy ${mu_strategy} -r 40 -j 10 -p -i --bootstrap_i $bootstrap_i # &> ../log/${conf}_${dataset}.log
