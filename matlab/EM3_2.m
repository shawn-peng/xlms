function [alpha, beta, u_c, sigma_c, lambda_c, u_i1, sigma_i1, lambda_i1] = EM3_2(S,sl1,sl2)
...
%     ll = func_ll2(S, alpha, u_c_new, Delta_c_new, Gamma_c, u_i_new, Delta_i_new, Gamma_i)
    ...
    Gamma_i2_new = ( sum( (1-Rsi2) .* ((s2 - u_i2_new).^2 - 2 * Vi22 .* (s2 - u_i2_new) * Delta_i2_new + Wi22 * Delta_i2_new^2) ) ) ...
        / (sum_Rsi2);
