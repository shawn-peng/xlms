...
%     disp(ll);
    ...
    plot_dist_fn(S, '_3s4c', alpha, (1-alpha)*beta, u_c, sigma_c, lambda_c, u_i1, sigma_i1, lambda_i1, u_i2, sigma_i2, lambda_i2, u_i3, sigma_i3, lambda_i3);
    pause(.001);
...
%     S2 = S(2,:);
    ...
    u_i1_new = (sum( R1 .* (s2 - Vi21 * Delta_i1) ) + sum( (1 - R1) .* (s1 - Vi1 * Delta_i1) )) / M;
