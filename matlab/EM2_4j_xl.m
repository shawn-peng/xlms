...
%     disp([alpha, beta, u_c, sigma_c, lambda_c, u_ic, sigma_ic, lambda_ic, u_i1, sigma_i1, lambda_i1, u_i2, sigma_i2, lambda_i2]);
    ...
    Rs = rsn_xl_d2i(s1, s2, ...
        ws, ...
        [u_c,  u_c,  u_ic, u_i1, u_ic, u_i1, u_i1;
         u_ic, u_i1, u_c,  u_c,  u_i1, u_ic, u_i2], ...
        [sigma_c,  sigma_c,  sigma_ic, sigma_i1, sigma_ic, sigma_i1, sigma_i1;
         sigma_ic, sigma_i1, sigma_c,  sigma_c,  sigma_i1, sigma_ic, sigma_i2], ...
        [lambda_c,  lambda_c,  lambda_ic, lambda_i1, lambda_ic, lambda_i1, lambda_i1;
         lambda_ic, lambda_i1, lambda_c,  lambda_c,  lambda_i1, lambda_ic, lambda_i2]);
