function [alpha, beta, ...
    ...
    u_i1, sigma_i1, lambda_i1] = EM1_3i_xl(S,sl1,sl2,sl3,range_c)
...
% prior_thres = 60;
prior_thres = S1_sorted(1) - (S1_sorted(1) - S1_sorted(M1)) * range_c;
prior_thres2 = S1_sorted(1) - (S1_sorted(1) - S1_sorted(M1)) * (range_c + (1-range_c)/2);
