...
lambda_c2  = -lambda_c1;
lambda_ic2 = lambda_ic1;
lambda_i12 = lambda_i11;
lambda_i22 = lambda_i22 * sl4;
...
% 
%     u_c2_new  = (sum( Rs2c  .* (s2 - Vc2  * Delta_c1 ) )) / (sum_Rs2c);
%     u_ic2_new = (sum( Rs2ic .* (s2 - Vic2 * Delta_ic1) )) / (sum_Rs2ic);
%     u_i12_new = (sum( Rs2i1 .* (s2 - Vi12 * Delta_i11) )) / (sum_Rs2i1);
