...
param_c_ic_check_func = make_param_check_function_s2combined( ...
    ...
    u_c, sigma_c, lambda_c, ...
    u_ic, sigma_ic, lambda_ic);
param_ic_i1_check_func = make_param_check_function_cdf( ...
    x_range, 1, 1, ...
    u_ic, sigma_ic, lambda_ic, ...
    u_i1, sigma_i1, lambda_i1);
param_i1_i2_check_func = make_param_check_function_cdf( ...
    x_range, 1, 1, ...
    u_i1, sigma_i1, lambda_i1, ...
...
%     end
    ...
    % param_i1_i2_check_func('u_1', u_i1_new, 1e-7)
    % param_i1_i2_check_func('u_2', u_i2_new, 1e-7)
    % param_i1_i2_check_func('sigma_1', sigma_i1_new, 1e-7)
    % param_i1_i2_check_func('sigma_2', sigma_i2_new, 1e-7)
    % param_i1_i2_check_func('lambda_1', lambda_i1, 1e-7)
    % param_i1_i2_check_func('lambda_2', lambda_i2, 1e-7)
    u_c = u_c_new;
    u_ic = u_ic_new;
    u_i1 = u_i1_new;
    u_i2 = u_i2_new;
