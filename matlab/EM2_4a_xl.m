...
% 
% syms sym_w_1 sym_w_2 sym_w_3 sym_w_4 sym_w_5 sym_w_6 sym_w_7;
% syms sym_lambda_1 sym_lambda_2 sym_lambda_3 sym_lambda_4;
% 
% syms sym_sum_R_1C  sym_sum_R_1IC sym_sum_R_1I1;
% syms sym_sum_R_2C  sym_sum_R_2IC sym_sum_R_2I1 sym_sum_R_2I2;
% 
% syms sym_p_C_IC sym_p_C_I1 sym_p_IC_I1;
% 
% eqns = [
% sym_sum_R_1C  + sym_sum_R_2IC + sym_w_1 * (sym_lambda_1 + (1 - sym_p_C_IC) * sym_lambda_2) == 0;
% sym_sum_R_1C  + sym_sum_R_2I1 + sym_w_2 * (sym_lambda_1 + (1 - sym_p_C_I1) * sym_lambda_3) == 0;
% sym_sum_R_1IC + sym_sum_R_2C  + sym_w_3 * (sym_lambda_1 - sym_p_C_IC  * sym_lambda_2) == 0;
% sym_sum_R_1I1 + sym_sum_R_2C  + sym_w_4 * (sym_lambda_1 - sym_p_C_I1  * sym_lambda_3) == 0;
% sym_sum_R_1IC + sym_sum_R_2I1 + sym_w_5 * (sym_lambda_1 + (1 - sym_p_IC_I1) * sym_lambda_4) == 0;
% sym_sum_R_1I1 + sym_sum_R_2IC + sym_w_6 * (sym_lambda_1 - sym_p_IC_I1 * sym_lambda_4) == 0;
% sym_sum_R_1I1 + sym_sum_R_2I2 + sym_w_7 * (sym_lambda_1) == 0;
% 
% sym_w_1 + sym_w_2 + sym_w_3 + sym_w_4 + sym_w_5 + sym_w_6 + sym_w_7 - 1 == 0;
% (1 - sym_p_C_IC) * sym_w_1 - sym_p_C_IC * sym_w_3 == 0;
% (1 - sym_p_C_I1) * sym_w_2 - sym_p_C_I1 * sym_w_4 == 0;
% (1 - sym_p_IC_I1) * sym_w_5 - sym_p_IC_I1 * sym_w_6 == 0;
% ];
% 
% E = solve(eqns, [sym_w_1 sym_w_2 sym_w_3 sym_w_4 sym_w_5 sym_w_6 sym_w_7]);
...
%     sigma_i2 = sigma_i2_new;
    update_ratio = 1;
    alpha = update_param(alpha_new, alpha, update_ratio);
    beta = update_param(beta_new, beta, update_ratio);
    u_c = update_param(u_c_new, u_c, update_ratio);
    u_ic = update_param(u_ic_new, u_ic, update_ratio);
    u_i1 = update_param(u_i1_new, u_i1, update_ratio);
    u_i2 = update_param(u_i2_new, u_i2, update_ratio);
    sigma_c = update_param(sigma_c_new, sigma_c, update_ratio);
    sigma_ic = update_param(sigma_ic_new, sigma_ic, update_ratio);
    sigma_i1 = update_param(sigma_i1_new, sigma_i1, update_ratio);
    sigma_i2 = update_param(sigma_i2_new, sigma_i2, update_ratio);
...
function new_val = update_param(val, old_val, update_ratio)
    new_val = old_val + (val - old_val) * update_ratio;
end
