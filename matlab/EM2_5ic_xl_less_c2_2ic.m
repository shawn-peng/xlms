...
param_i1_i2_check_func = make_param_check_function( ...
    ...
    constraints);
% param_ic_ic2_check_func = make_param_check_function( ...
%     x_range, 1, 1, ...
%     u_ic, sigma_ic, lambda_ic, ...
...
% if ~param_ic_ic2_check_func('sigma_2', sigma_ic, 1e-7)
% 
%     param_ic_ic2_check_func = make_param_check_function( ...
%         x_range, 1, 1, ...
%         u_ic, sigma_ic, lambda_ic, ...
%         u_ic-10, sigma_ic, lambda_ic2, ...
%         constraints);
%     param_ic_i1_check_func = make_param_check_function( ...
%         x_range, 1, 1, ...
%         u_ic, sigma_ic, lambda_ic, ...
...
while abs(ll - prev_ll) > tolerance
    ...
    % u_ic_new = param_bin_search(u_ic, u_ic_new, @(x, fuzzy) param_ic_ic2_check_func('u_1', x, fuzzy));
    % u_ic2_new = param_bin_search(u_ic2, u_ic2_new, @(x, fuzzy) param_ic_ic2_check_func('u_2', x, fuzzy));
    ...
    % sigma_ic_new = param_bin_search(sigma_ic, sigma_ic_new, @(x, fuzzy) param_ic_ic2_check_func('sigma_1', x, fuzzy));
    % sigma_ic2_new = param_bin_search(sigma_ic2, sigma_ic2_new, @(x, fuzzy) param_ic_ic2_check_func('sigma_2', x, fuzzy));
    ...
    % lambda_ic_new = param_bin_search(lambda_ic, lambda_ic_new, @(x, fuzzy) param_ic_ic2_check_func('lambda_1', x, fuzzy));
    % lambda_ic2_new = param_bin_search(lambda_ic2, lambda_ic2_new, @(x, fuzzy) param_ic_ic2_check_func('lambda_2', x, fuzzy));
