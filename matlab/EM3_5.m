function [alpha, beta, u_c, sigma_c, lambda_c, u_i1, sigma_i1, lambda_i1, u_i2, sigma_i2, lambda_i2, u_i3, sigma_i3, lambda_i3] = EM3_5(S,sl1,sl2,sl3,sl4)
...
%     S2 = S(2,:);
    ...
    Rsn1 = rsn(s1, [alpha, 1-alpha], [u_c, u_i1], [sigma_c, sigma_i1], [lambda_c, lambda_i1]);
    Rsn2 = rsn(s2, [beta, alpha, 1-alpha-beta], [u_c, u_i1, u_i2], [sigma_c, sigma_i1, sigma_i2], [lambda_c, lambda_i1, lambda_i2]);
    Rsn3 = rsn(s3, [alpha+beta, 1-alpha-beta], [u_i2, u_i3], [sigma_i2, sigma_i3], [lambda_i2, lambda_i3]);
    Rs1c = Rsn1(1,:);
    Rs1i1 = Rsn1(2,:);
    Rs2c = Rsn2(1,:);
    Rs2i1 = Rsn2(2,:);
