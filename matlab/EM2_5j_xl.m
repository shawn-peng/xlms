...
ni1 = sum(S1_sorted <= prior_thres2);
...
lambda_ic2 = lambda_ic2 * sl4;
lambda_i2  = lambda_i2  * sl5;
...
p_ic_ic2_i1 = sum(sim_xic > sim_xic2 & sim_xic2 > sim_xi1) / SIM_SIZE;
...
%     figure(fig);
    ...
    disp(ll);
%     disp(ll - prev_ll);
%     disp([alpha, beta, u_c, sigma_c, lambda_c, u_ic1, sigma_ic1, lambda_ic1, u_i1, sigma_i1, lambda_i1, u_i2, sigma_i2, lambda_i2]);
    ...
    [Vic2,  Wic2 ] = trunc_norm_moments(delta_ic1  / sigma_ic1  * (s2-u_ic1 ), sqrt(1-delta_ic1 ^2));
    ...
    Rs = rsn_xl_d2i(s1, s2, ...
        ws, ...
        [u_c,  u_c,  u_ic1, u_i1, u_ic1, u_i1, u_ic1,  u_i1;
         u_ic1, u_i1, u_c,  u_c,  u_i1, u_ic1, u_ic2, u_i2], ...
        [sigma_c,  sigma_c,  sigma_ic1, sigma_i1, sigma_ic1, sigma_i1, sigma_ic1,  sigma_i1;
         sigma_ic1, sigma_i1, sigma_c,  sigma_c,  sigma_i1, sigma_ic1, sigma_ic2, sigma_i2], ...
        [lambda_c,  lambda_c,  lambda_ic1, lambda_i1, lambda_ic1, lambda_i1, lambda_ic1,  lambda_i1;
         lambda_ic1, lambda_i1, lambda_c,  lambda_c,  lambda_i1, lambda_ic1, lambda_ic2, lambda_i2]);
...
%     Rs2i2 = Rs_i1i2;
    ...
    Rs1c   = Rsj1 + Rsj2;
    Rs1ic  = Rsj3 + Rsj5 + Rsj7;
    Rs1i1  = Rsj4 + Rsj6 + Rsj8;
...
%     beta_new = w1 + w3 + w5 + w6;
    ...
    u_ic1_new =  (sum( Rs1ic  .* (s1 - Vic1  * Delta_ic1 ) ) + ...
                 sum( Rs2ic  .* (s2 - Vic2  * Delta_ic1 ) )) / (sum_Rs1ic + sum_Rs2ic);
    ...
    Gamma_ic1_new = ( sum( Rs1ic .* ((s1 - u_ic1_new).^2 - ...
                     ...
                     sum( Rs2ic .* ((s2 - u_ic1_new).^2 - ...
                                    2 * Vic2 .* (s2 - u_ic1_new) * Delta_ic1_new + ...
                                    Wic2 * Delta_ic1_new^2) ) ...
                     ) / (sum_Rs1ic + sum_Rs2ic);
